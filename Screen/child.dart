...
class _TodoScreenState extends State<Child> {
  
  List<String> compulsoryTexts = ['Brashing /Bathing', 'Study and Do Homework', '30 Minutes of Active Play'];
  List<bool> compulsoryChecked = [false, false, false];
